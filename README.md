...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/rlp-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=10560&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/rlp-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `rlp` can be installed with:

```
conda install rlp
```

It is possible to list all of the versions of `rlp` available on your platform with:
